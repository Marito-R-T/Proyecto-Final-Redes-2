...
IN="/dev/sbin/tc filter add dev ${INTERFACEIN} parent 1:0 protocol ip prio 1 u32 match ip dst"
OUT="/dev/sbin/tc filter add dev ${INTERFACEOUT} parent 1:0 protocol ip prio 1 u32 match ip src"
